...
const Header = () => {
    ...
    return (
        <div className="mb-6">
            ...
            <p className="text-zinc-400">Lets see what we have got to do today.</p>
        </div>
    );

};

const Form = ({ setTodos }: {setTodos:any;}) => {
...
const Todos = ({ todos, handleCheck, removeElement }: {todos:any; handleCheck:any; removeElement:any;}) => {
...
const Todo = ({ removeElement, handleCheck, id, children, checked, time }: {id:string; time: number; handleCheck:any; checked: any; children: ReactNode; removeElement:any;}) => {
    ...
    return (
        ...
        >
            ...
            <p className={`text-white transition-colors ${checked && "text-zinc-400"}`} >
                {children}
            </p>
